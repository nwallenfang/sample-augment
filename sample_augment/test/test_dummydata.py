...
# raise DeprecationWarning("This test is deprecated, uses old interfaces.")
#
...
#     complete = AugmentDataset.load_from_file(Path(project_path('data/interim/gc10_tensors.pt')))
...
#     train = AugmentDataset.load_from_file(Path(project_path('data/interim/gc10_train.pt')))
#     complete = AugmentDataset.load_from_file(Path(project_path('data/interim/gc10_tensors.pt')))
#     n_complete = len(complete)
#     del complete
#     test = AugmentDataset.load_from_file(Path(project_path('data/interim/gc10_test.pt')))
#     val = AugmentDataset.load_from_file(Path(project_path('data/interim/gc10_val.pt')))
...
#     dataset = AugmentDataset.load_from_file(Path(project_path('data/interim/gc10_train.pt')))
