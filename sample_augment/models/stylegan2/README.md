...
![Teaser image](models_package/stylegan2/docs/stylegan2-ada-teaser-1024x252.png)
...
* Docker users: use the [provided Dockerfile](models_package/stylegan2/Dockerfile) to build an image with the required library dependencies.
...
Please refer to [`generate.py`](models_package/stylegan2/generate.py), [`style_mixing.py`](models_package/stylegan2/style_mixing.py), and [`projector.py`](models_package/stylegan2/projector.py) for further examples.

## Preparing datasets

Datasets are stored as uncompressed ZIP archives containing uncompressed PNG files and a metadata file `dataset.json` for labels.

Custom datasets can be created from a folder containing images; see [`python dataset_tool.py --help`](models_package/stylegan2/docs/dataset-tool-help.txt) for more information. Alternatively, the folder can also be used directly as a dataset, without running it through `dataset_tool.py` first, but doing so may lead to suboptimal performance.
...
Please refer to [`python train.py --help`](models_package/stylegan2/docs/train-help.txt) for the full list.
...
![Training curves](models_package/stylegan2/docs/stylegan2-ada-training-curves.png)
