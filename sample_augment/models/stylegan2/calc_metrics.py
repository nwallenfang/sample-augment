...
@click.option('--data_package', help='Dataset to evaluate metrics against (directory or zip) [default: same as training data_package]', metavar='PATH')
...
def calc_metrics(ctx, network_pkl, metrics, data, mirror, gpus, verbose):
    ...
    python calc_metrics.py --metrics=fid50k_full --data_package=~/datasets/ffhq.zip --mirror=1 \\
    ...
    if data is not None:
        ...
        ctx.fail('Could not look up dataset options; please specify --data_package')
